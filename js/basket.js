// basket.js
import { getCart, setCart, formatRub, updateCounter } from "./cart-utils.js";
  ...
  const html = cart.map(item => {
    ...
    return `
      <div class="t-shirt-card" data-id="${item._id}">
        ...
        <div class="price">
          <div class="quantity">
            <button class="qty-btn" data-action="decrease" data-id="${item._id}" style="cursor: pointer">−</button>
            <span class="qty-value">${qty}</span>
            <button class="qty-btn" data-action="increase" data-id="${item._id}" style="cursor: pointer">+</button>
          </div>
          <div class="pr">
            ${disc
              ? `
